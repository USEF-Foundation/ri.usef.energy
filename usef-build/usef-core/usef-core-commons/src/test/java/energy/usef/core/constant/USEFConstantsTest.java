 ...
 *
 */
public class USEFConstantsTest extends TestCase {
    @Test
    public void testUtilityClass() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Assert.assertEquals("There must be only one constructor", 1, USEFConstants.class.getDeclaredConstructors().length);
        Constructor<USEFConstants> constructor = USEFConstants.class.getDeclaredConstructor();
