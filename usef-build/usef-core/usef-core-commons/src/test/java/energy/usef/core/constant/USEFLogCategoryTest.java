 ...
 *
 */
public class USEFLogCategoryTest extends TestCase {
    @Test
    public void testUtilityClass() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Assert.assertEquals("There must be only one constructor", 1, USEFLogCategory.class.getDeclaredConstructors().length);
        Constructor<USEFLogCategory> constructor = USEFLogCategory.class.getDeclaredConstructor();
