...
/**
 * Entity class {@link Exchange}: This class is an implementation for {@link Document} classes related to a message.
 *
 */
@Entity
@Table(name = "EXCHANGE")
public class Exchange extends Document {

    @Column(name = "PARTICIPANT_DOMAIN", nullable = true)
