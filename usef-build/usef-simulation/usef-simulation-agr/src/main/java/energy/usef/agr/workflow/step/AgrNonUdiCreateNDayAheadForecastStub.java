 ...
 * <ul>
 * <li>PTU_DATE : PTU day {@link LocalDate}.</li>
 ...
 * </ul>
 */
public class AgrNonUdiCreateNDayAheadForecastStub implements WorkflowStep {
    private static final Logger LOGGER = LoggerFactory.getLogger(AgrNonUdiCreateNDayAheadForecastStub.class);
    ...
    public WorkflowContext invoke(WorkflowContext context) {
        LOGGER.info("AgrNonUdiCreateNDayAheadForecastStub step is invoked");
        ...
        connections = pbcFeederService.retrieveNonUDIListWithForecast(forecastDay, connections, ptuDuration);

        context.setValue(ConnectionForecastStepParameter.OUT.CONNECTION_PORTFOLIO.name(), connections);
        LOGGER.info("Workflow AgrNonUdiCreateNDayAheadForecastStub ended.");
        return context;
    }
}
