...
import energy.usef.core.workflow.settlement.CoreInitiateSettlementParameter.IN;
...
/**
 * Test class in charge of the unit test related to the {@link DsoInitiateSettlementStub} class.
 */
public class DsoInitiateSettlementStubTest {
    ...
    private DsoInitiateSettlementStub dsoInitiateSettlementStub;

    @Before
    public void setUp() throws Exception {
        dsoInitiateSettlementStub = new DsoInitiateSettlementStub();
    }

    @Test
    public void testInvokeWithSmartMeterData() throws Exception {
        WorkflowContext outContext = dsoInitiateSettlementStub.invoke(buildWorkflowContextWithMeterData());
    ...
    public void testInvokeWithGridMonitoringData() throws Exception {
        WorkflowContext outContext = dsoInitiateSettlementStub.invoke(buildWorkflowContextWithGridMonitoring());
        SettlementDto settlementDto = outContext.get(OUT.SETTLEMENT_DTO.name(), SettlementDto.class);
        Assert.assertNotNull(settlementDto);
        Assert.assertEquals(2, settlementDto.getFlexOrderSettlementDtos().size());
