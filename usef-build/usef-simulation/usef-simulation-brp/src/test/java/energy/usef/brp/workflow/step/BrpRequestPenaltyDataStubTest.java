...
/**
 * Test class for {@link BrpRequestPenaltyDataStub}
 */
@RunWith(PowerMockRunner.class)
public class BrpRequestPenaltyDataStubTest {

    private static final int PTUS_PER_DAY = 96;
    @Mock
    PbcFeederService pbcFeederService;

    private BrpRequestPenaltyDataStub brpRequestPenaltyDataStub;

    @Before
    public void init() {
        brpRequestPenaltyDataStub = new BrpRequestPenaltyDataStub();

        Whitebox.setInternalState(brpRequestPenaltyDataStub, pbcFeederService);
    ...
    public void testInvokeWithNoDeficiency() throws Exception {
        WorkflowContext context = brpRequestPenaltyDataStub.invoke(buildWorkflowContext(new BigInteger(String.valueOf(0))));
    ...
    public void testInvokeWithDeficiency() throws Exception {
        WorkflowContext context = brpRequestPenaltyDataStub.invoke(buildWorkflowContext(new BigInteger(String.valueOf(100))));
