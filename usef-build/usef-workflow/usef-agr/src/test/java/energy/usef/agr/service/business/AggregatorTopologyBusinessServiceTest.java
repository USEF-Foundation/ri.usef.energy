...
public class AggregatorTopologyBusinessServiceTest {
    ...
    @Before
    public void init() {
        service = new AggregatorTopologyBusinessService();
    ...
    public void testProcessConnectionBatch() throws Exception
    {
        ...
        try {
            String jsonText = "["
                    ...
                    + "{\"method\" : \"POST\", \"entityAddress\": \"ean.0000000000001\", \"isCustomer\": true},"
                    + "{\"method\" : \"DELETE\", \"entityAddress\": \"ea1.2007-11.net.usef.energy:1-2\"},"
                    + "{\"method\" : \"POST\", \"entityAddress\": \"ea1.2007-11.net.usef.energy:1-3\", \"isCustomer\": true},"
                    + "{\"method\" : \"DELETE\", \"entityAddress\": \"ea1.2007-11.net.usef.energy:1-4\"},"
                    + "{\"method\" : \"POST\", \"entityAddress\": \"ea1.2007-11.net.usef.energy:1-5\", \"isCustomer\": true},"
                    + "{\"method\" : \"MAIL\", \"entityAddress\": \"ea1.2007-11.net.usef.energy:1-6\", \"isCustomer\": true},"
                    + "{\"methode\" : \"POST\", \"entityAddress\": \"ea1.2007-11.net.usef.energy:1-7\", \"isCustomer\": true},"
                    + "{\"method\" : \"POST\", \"entityAddres\": \"ea1.2007-11.net.usef.energy:1-8\", \"isCustomer\": true},"
                    + "{\"method3\" : \"POST\", \"entityAddress\": \"ea1.2007-11.net.usef.energy:1-9\", \"additional\": 12, \"isCustomer\": true}"
                    + "]";
    ...
    private void verifyConnectionCalls(String entityAddress, int persists, int deletes) {
        Mockito.verify(synchronisationConnectionRepository, Mockito.times(persists)).persist(createSynchronisationConnection(entityAddress, true));
    ...
    private void mockConnection(String entityAddress, boolean exists)  throws BusinessValidationException{
        SynchronisationConnection connection = createSynchronisationConnection(entityAddress, true);
        if (exists) {
    ...
    private SynchronisationConnection createSynchronisationConnection(String entityAddress, boolean isCustomer) {
        ...
        synchronisationConnection.setLastModificationTime(new LocalDateTime(2016,1,1,0,0,0,0));
    ...
    private SynchronisationConnection createSynchronisationConnection(Long id, String entityAddress, boolean isCustomer) {
        SynchronisationConnection object = new SynchronisationConnection();
        object.setId(id);
        object.setEntityAddress(entityAddress);
        object.setCustomer(isCustomer);
    ...
    public void testFindAllSynchronisationConnections() throws BusinessValidationException, IOException{
        ...
        participants.add(createSynchronisationConnection(1L, "ean.0000000000000", true));
        participants.add(createSynchronisationConnection(2L, "ean.0000000000002", true));
        ...
        assertRestResult(200,
                "[{\"id\":1,\"entityAddress\":\"ean.0000000000000\",\"lastModificationTime\":\"2016-01-01T00:00:00.000\",\"customer\":true},{\"id\":2,\"entityAddress\":\"ean.0000000000002\",\"lastModificationTime\":\"2016-01-01T00:00:00.000\",\"customer\":true}]", 0, result);
