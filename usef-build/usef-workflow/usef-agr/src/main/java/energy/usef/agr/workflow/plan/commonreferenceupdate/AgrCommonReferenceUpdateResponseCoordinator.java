 ...
 */
@Stateless
public class AgrCommonReferenceUpdateResponseCoordinator {

    private static final Logger LOGGER = LoggerFactory.getLogger(AgrCommonReferenceUpdateResponseCoordinator.class);
