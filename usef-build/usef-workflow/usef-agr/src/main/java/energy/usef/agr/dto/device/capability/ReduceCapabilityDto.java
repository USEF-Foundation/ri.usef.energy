...
/**
 * JSON class representing a reduce capability of a UDI device. This class extends {@link VariationCapabilityDto}.
 */
public class ReduceCapabilityDto extends VariationCapabilityDto {
