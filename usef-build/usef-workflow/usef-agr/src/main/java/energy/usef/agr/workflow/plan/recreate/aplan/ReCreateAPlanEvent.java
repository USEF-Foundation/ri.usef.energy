...
public class ReCreateAPlanEvent implements ExpirableEvent {
     ...
     * Default constructor.
     *
     * @param period {@link org.joda.time.LocalDate} period for which A-Plans will be recreated. If <code>null</code>, it will be
     * set to the current date.
     */
    public ReCreateAPlanEvent(LocalDate period) {
