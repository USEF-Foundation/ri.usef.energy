...
public class BalanceResponsiblePartyValidationBusinessServiceTest {

    BalanceResponsiblePartyValidationBusinessService service;
    ...
    @Before
    public void init() {
        service = new BalanceResponsiblePartyValidationBusinessService();
