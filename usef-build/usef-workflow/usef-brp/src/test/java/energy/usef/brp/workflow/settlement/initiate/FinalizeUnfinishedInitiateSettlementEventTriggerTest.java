...
/**
 * Test class in charge of the unit tests related to the {@link FinalizeUnfinishedInitiateSettlementEventTrigger} class.
 */
...
public class FinalizeUnfinishedInitiateSettlementEventTriggerTest {
    ...
    public void init() throws Exception {
        ...
        PowerMockito.when(configBrp.getIntegerProperty(ConfigBrpParam.BRP_METER_DATA_QUERY_EXPIRATION_CHECK_INTERVAL_IN_MINUTES))
                .thenReturn(60);
    }
