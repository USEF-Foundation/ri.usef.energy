...
/**
 * Coordinator class for the workflow 'Revoke Flex Offer' (BRP side).
 */
@Singleton
public class BrpFlexOfferRevocationCoordinator {

    private static final Logger LOGGER = LoggerFactory.getLogger(BrpFlexOfferRevocationCoordinator.class);
