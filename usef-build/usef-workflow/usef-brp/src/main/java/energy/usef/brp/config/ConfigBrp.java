 ...
 */
@ApplicationScoped
public class ConfigBrp extends AbstractConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(ConfigBrp.class);
     ...
     */
    public String getProperty(ConfigBrpParam configParam) {
        if (properties == null) {
            return null;
        }
     ...
     * @return property value
     */
    public Integer getIntegerProperty(ConfigBrpParam configParam) {
