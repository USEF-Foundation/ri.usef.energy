...
public class FinalizeInitiateSettlementEvent {
     ...
     * @param meterDataSets
     */
    public FinalizeInitiateSettlementEvent(LocalDate startDate, LocalDate endDate,
    ...
    public List<MeterDataSet> getConnectionGroupList() {
    ...
    public String toString() {
        return "FinalizeInitiateSettlementEvent" + "[" +
                "startDate=" + startDate +
                ", endDate=" + endDate +
                ", #meterDataSets=" + getConnectionGroupList().size() +
                "]";
    }
}
