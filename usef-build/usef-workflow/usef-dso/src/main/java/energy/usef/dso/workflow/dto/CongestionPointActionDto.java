...
/**
 * A data transfer object for relevant CongestionPoint data.
 */
public class CongestionPointActionDto {
    ...
    public List<ConnectionActionDto> getConnections() {
        if (connections == null) {
    ...
    public void setConnections(List<ConnectionActionDto> connections) {
