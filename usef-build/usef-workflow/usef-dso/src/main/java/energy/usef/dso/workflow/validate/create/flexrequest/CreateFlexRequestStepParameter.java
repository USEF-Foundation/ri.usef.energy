...
/**
 * Contains the parameters for the step DSOCreateFlexRequest.
 */
public class CreateFlexRequestStepParameter {

    private CreateFlexRequestStepParameter() {
        // private constructor
    }
