...
/**
 * Test class in charge of the unit tests related to the event triggering in the DSO Initiate Settlement workflow.
 */
...
public class CollectSmartMeterDataEventTriggerTest {
    ...
    public void init() {
        ...
        PowerMockito.when(configDso.getProperty(ConfigDsoParam.DSO_INITIATE_SETTLEMENT_TIME)).thenReturn("11:00");
    }
    ...
    public void testEventTriggerIsCorrectlyRegisteredEventFired() {
        ...
        PowerMockito.when(configDso.getProperty(ConfigDsoParam.DSO_INITIATE_SETTLEMENT_DAY_OF_MONTH)).thenReturn(
    ...
    public void testEventTriggerIsCorrectlyRegisteredButEventNotFired() {
        ...
        registeredWorkItemExecution.execute();
        Mockito.verify(eventManager, Mockito.times(0)).fire(Matchers.any(CollectSmartMeterDataEvent.class));
    }
