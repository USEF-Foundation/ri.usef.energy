...
public class WorkflowParameterTest extends TestCase {
    ...
    public void testUtilityClass() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Assert.assertEquals("There must be only one constructor", 1, WorkflowParameter.class.getDeclaredConstructors().length);
        Constructor<WorkflowParameter> constructor = WorkflowParameter.class.getDeclaredConstructor();
