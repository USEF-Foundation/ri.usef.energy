 ...
 */
public class CommonReferenceQueryStateRepositoryTest {
    /**
    ...
    private CommonReferenceQueryStateRepository repository;

    @Test
    public void testFind() {
        CommonReferenceQueryState state = repository.find(-1l);
        assertNull(state);
    }
