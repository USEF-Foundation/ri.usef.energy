...
/**
 * JUnit test for the MeterDataCompanyRepository class (CRO).
 */
...
public class MeterDataCompanyRepositoryTest {
    ...
    /**
     * Tests for MeterDataCompany.getMeterDataCompanyByDomain method.
     */
    @Test
    public void testFindByExistentDomain() {
        String domain = "mdc.test.com";
        MeterDataCompany mdc = repository.findByDomain(domain);
        assertNotNull("Existent MDC", mdc);
    }
    ...
    public void testFindByNonexistentDomain() {
        ...
        MeterDataCompany mdc = repository.findByDomain(domain);
        assertNull("Nonexistent MDC", mdc);
    }
}
