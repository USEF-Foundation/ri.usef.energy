 ...
 */
@ApplicationScoped
public class ConfigCro extends AbstractConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(ConfigCro.class);
     ...
     */
    public String getProperty(ConfigCroParam configParam) {
        if (properties == null) {
            return null;
        }
     ...
     * @return property value
     */
    public Integer getIntegerProperty(ConfigCroParam configParam) {
