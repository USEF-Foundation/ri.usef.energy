...
public class CommonReferenceOperatorTopologyBusinessService {
    ...
    /**
     * Try and retrieve an {@link Aggregator} with the given domain name, retruning it in a {@Link RestResult}.
     *
    ...
    /**
     * Try and retrieve an {@link BalanceResponsibleParty} with the given domain name, retruning it as a {@Link RestResult}.
     *
    ...
    /**
     * Try and retrieve an {@link DistributionSystemOperator} with the given domain name, retruning it as a {@Link RestResult}.
     *
    ...
    /**
     * Try and retrieve an {@link MeterDataCompany} with the given domain name, retruning it as a {@Link RestResult}.
     *
