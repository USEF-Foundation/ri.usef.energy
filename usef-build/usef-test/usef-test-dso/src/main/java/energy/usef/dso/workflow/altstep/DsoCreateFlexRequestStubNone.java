 ...
 * </ul>
 */
public class DsoCreateFlexRequestStubNone implements WorkflowStep {
    private static final int MINIMUM_REQUESTED_PTUS = 2;
    private static final int FLEX_REQUEST_EXPIRATION_DAYS = 4;

    private static final Logger LOGGER = LoggerFactory.getLogger(DsoCreateFlexRequestStubNone.class);
