 ...
 * </ul>
 */
public class DsoPlaceFlexOrdersStubOrderOne implements WorkflowStep {
    private static final Logger LOGGER = LoggerFactory.getLogger(DsoPlaceFlexOrdersStubOrderOne.class);
