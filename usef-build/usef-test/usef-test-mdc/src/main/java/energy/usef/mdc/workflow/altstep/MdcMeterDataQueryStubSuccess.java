 ...
 */
public class MdcMeterDataQueryStubSuccess implements WorkflowStep {
    private static final Logger LOGGER = LoggerFactory.getLogger(MdcMeterDataQueryStubSuccess.class);
