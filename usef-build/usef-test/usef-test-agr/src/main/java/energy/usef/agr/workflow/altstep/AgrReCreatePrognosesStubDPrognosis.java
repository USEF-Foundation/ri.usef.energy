 ...
 * re-optimization of the portfolio. This version only recreates the D-Prognoses.
 * <p>
 ...
 * </ul>
 */
public class AgrReCreatePrognosesStubDPrognosis implements WorkflowStep {

    private static final Logger LOGGER = LoggerFactory.getLogger(AgrReCreatePrognosesStubDPrognosis.class);
