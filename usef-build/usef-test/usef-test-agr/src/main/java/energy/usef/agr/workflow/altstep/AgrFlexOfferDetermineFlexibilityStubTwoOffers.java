...
public class AgrFlexOfferDetermineFlexibilityStubTwoOffers implements WorkflowStep {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AgrFlexOfferDetermineFlexibilityStubTwoOffers.class);
    ...
    public WorkflowContext invoke(WorkflowContext context) {
        ...
        List<FlexRequestDto> inputFlexRequests = (List<FlexRequestDto>) context.getValue(
        ...
        for (FlexRequestDto flexRequestDto : inputFlexRequests) {
            decision = 0;//RANDOM.nextInt(3); // 0,1 or 2
            ...
            if (decision == 0) {
                ...
                LOGGER.debug("Two new FlexOffers will be created for FlexRequest with sequence [{}]",
