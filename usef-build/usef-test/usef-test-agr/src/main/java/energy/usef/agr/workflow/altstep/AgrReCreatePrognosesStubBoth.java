 ...
 * </ul>
 */
public class AgrReCreatePrognosesStubBoth implements WorkflowStep {

    private static final Logger LOGGER = LoggerFactory.getLogger(AgrReCreatePrognosesStubBoth.class);
